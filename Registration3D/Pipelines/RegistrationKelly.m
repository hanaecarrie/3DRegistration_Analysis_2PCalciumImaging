function [] = RegistrationKelly(mouse, date, runs, refchannel, ...
    edges, blurfactor, keepingfactor, n, planescorr,...
    nbchunck, m1, varargin)
% REGISTRATIONKELLY: performs registration of Kelly movies
...
%         should divide the total number of volumes (ex: 100)
...
%         should divide the number of volumes (ex: 1)
...
%     none
    ...
    addOptional(p, 'savingpathbegin',...
        'E:\hanae_data\Kelly\registrationFiles\'); 
    % default saving location
    addOptional(p, 'version', 'hanae');  % 'hanae' or 'freds'
    addOptional(p, 'sizedata', [512, 796, 31, 100]);  % data size
        ...
        if p.version == 'hanae'
            ...
            if ~exist(strcat(savingpath, mouse, '_', date, '_',...
                ...
                affineRegistrationPerPlane(mouse, date, run, newruns, ...
                    refchannel, datareg3, EdgesWarp, 1, nbchunck,...
            ...
            elseif ~exist(strcat(savingpath, mouse, '_', date, '_',...
                ...
                affineRegistrationPerPlane(mouse, date,...
                    run, newruns, refchannel, datareg3, EdgesWarp, 1,...
    ...
    tEndRM = toc(tStartRM);
    fprintf('RegistrationKelly in %d minutes and %f seconds\n.', ...
