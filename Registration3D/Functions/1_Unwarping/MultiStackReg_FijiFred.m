...
% MULTISTACKREG_FIJIFRED: Compute and apply unwarping on both channels with 
% affine and dft transformation along the z axis for a given volume
% Credits: Fred Shipley

%   Inputs:
%     mean_vol -- 3D matrix (x,y,z) averaged volume to compute shifts on 
%   Outputs:
%     tform_cum -- list of affine 2D object, cumulative affine transforms
